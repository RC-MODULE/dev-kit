...
.PHONY = arm-toolchain install-arc install-arm

install-all: $(WGET) install-nmc install-gnu install-arm
...
$(7ZIP) $(WGET): 
	-@mkdir gnuwin32
	-@mkdir gnuwin32\bin
	powershell  -ExecutionPolicy Bypass -file wget.ps1  $(ZIP7_URL) $(WGET_BIN_URL) $(WGET_DEP_URL) 
